...
RSpec.describe 'index.html' do
  ...
  it 'contains a <table> with the correct headers' do
    ...
    expect(headers.children[1].children[0].text).to eq("State")
    expect(headers.children[2].children[0].text).to eq("2017 estimate")
  end
  ...
  it 'contains the correct information about New York City' do
    ...
    expect(new_york.children[1].children[0].text).to eq("New York")
    expect(new_york.children[2].children[0].text).to be == "8,622,698"
  end
  ...
  it 'contains the correct information about California' do
    ...
    expect(new_york.children[1].children[0].text).to eq("California")
    expect(new_york.children[2].children[0].text).to be == "3,999,759"
  end
  ...
  it 'contains the correct information about Chicago' do
    ...
    expect(new_york.children[1].children[0].text).to eq("Illinois")
    expect(new_york.children[2].children[0].text).to be == "2,716,450"
  end
  ...
  it 'contains the correct information about Houston' do
    ...
    expect(new_york.children[1].children[0].text).to eq("Texas")
    expect(new_york.children[2].children[0].text).to be == "2,312,717"
  end
